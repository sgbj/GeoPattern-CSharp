...
{
    public class ConcentricCirclesGenerator : PatternGenerator
    {
        public ConcentricCirclesGenerator(string str, Dictionary<string, object> options) : base(str, options)
        {
        }
